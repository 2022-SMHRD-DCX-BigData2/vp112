...
<%@ include file="header.jsp" %>
    ...
    <script>
      ...
      //문제
      var problem_arr = ['경찰, 검찰, 금융감독원 등 수사기관에서 범죄에 연류되었다고 공문을 보내며 계좌번호, 금전을 유도한다면 그대로 따라야 한다.',
    	  				 '금융기관으로부터 전화나 문자메세지로 대출을 권유받는다면 먼저 출처가 분명한 곳인지 확인해야 한다.',
    	  				 '출처가 불분명한 곳으로부터 문자나 전화를 통해 휴대폰에 앱설치를 요구한다면 바로 삭제하거나 전화를 끊어버린다.',
                         '‘자녀를 납치했다 경찰에 신고하지말고 시키는대로 돈을 준비해라’와 같은 보이스피싱 전화를 받게 되면 경찰에 신고하지 말아야 한다.',
      ...
      function btnResFunc(){
         Swal.fire({
            title: '',
            text: '',
            html: "<b>당신의 금융사기예방 OX퀴즈 점수는 " + score + "점입니다.</b>",
            icon: 'success',
